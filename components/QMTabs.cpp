...
void QtMaterialTabsPrivate::QtMaterialTabsPrivate::init()
{
    ...
    tabLayout = new QBoxLayout(QBoxLayout::Direction::LeftToRight);
...
QtMaterialTabs::QtMaterialTabs(QWidget *parent)
  ...
  d_func()->init();
  _inkBarPosition = QtMaterialTabsInkBar::InkBarPosition::BOTTOM;
}
...
void QtMaterialTabs::setDirection(QBoxLayout::Direction direction) {
  _direction = direction;
  Q_D(const QtMaterialTabs);
  d->tabLayout->setDirection(_direction);
  update();
}

QBoxLayout::Direction QtMaterialTabs::direction() const { return _direction; }

void QtMaterialTabs::setInkBarPosition(
...
void QtMaterialTabs::updateTabs() {
  Q_D(QtMaterialTabs);
  d_ptr->inkBar->setInkBarPosition(_inkBarPosition);
  d_ptr->inkBar->setThickness(4);
  QtMaterialTab *tab;
